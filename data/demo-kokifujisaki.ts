...
const flowsByYear: Record<number, Flow[]> = {
  ...
  2024: [
    // TODO: 2024年のflowsデータをここに追加
    // 収入
    {
      id: 'i1',
      name: '前年からの繰越額',
      direction: 'income',
      value: 0, // TODO: 2024年の値を設定
      parent: '総収入',
    },
    {
      id: 'i2',
...
const incomeTransactionsByYear: Record<number, OldTransaction[]> = {
  ...
  2024: [
    // TODO: 2024年のincomeTransactionsデータをここに追加
    {
      id: 'i1',
      name: '前年からの繰越額',
      date: '2024/1/1',
...
const expenseTransactionsByYear: Record<number, OldTransaction[]> = {
  ...
  2024: [
    // TODO: 2024年のexpenseTransactionsデータをここに追加
    {
      id: 'e1',
      name: '人件費',
      date: '2024/12/31',
